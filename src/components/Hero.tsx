        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-8 max-w-2xl text-lg md:text-xl leading-9 text-zinc-600">
              Diseñamos estrategias enfocadas en crecimiento,
              conversión y rentabilidad para tiendas online que
                ...
                <div className="rounded-3xl bg-lime-50 p-5 border border-lime-100">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm leading-7 text-zinc-700">
                      Estrategias enfocadas en crecimiento,
                      automatización y escalabilidad para ecommerce.
                    </p>
                  </div>
                </div>
              </div>
